...
# Datos Nexpose
serveraddrnex = 'localhost'
portnex = 3780
usernamenex = 'jmurillob'
passwordnex = 'JORDI.murill'
...
def attack_ssh(passwd):
    try:
        ...
        fd.write ("\n")
        fd.write("Password SSH Valido %s  \n" %(passwd.rstrip()))
        client.close()
    except:
        pass
...
n = pynexpose.NeXposeServer(serveraddrnex, portnex, usernamenex, passwordnex)
fd.write(n.site_listing())
fd.write(n.site_config(1))
fd.write(n.site_device_listing(1))
fd.write(n.site_scan(1))
fd.write(n.site_scan_history(1))
#fd.write(n.vulnerability_listing())
fd.write(n.vulnerability_details(10))
print n.site_listing()
print n.site_config(1)
print n.site_device_listing(1)
print n.site_scan(1)
print n.site_scan_history(1)
#print n.vulnerability_listing()
print n.vulnerability_details(10)
n.logout()
